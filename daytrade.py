...
params={
    "min_growth":{"start":0.02,"end":0.04,"step":0.01},
    "min_decay":{"start":-0.04,"end":-0.02,"step":0.01},
    "starting_value":{"start":4000,"end":6000,"step":1000},
    ...
    "min_minutes_before_first_buy":{"start":20,"end":40,"step":10}
}
...
with open(out_file_name,"w") as f:
    out_html=json2html.convert(json = json.dumps({"params":params,"summary":sorted_result}))
